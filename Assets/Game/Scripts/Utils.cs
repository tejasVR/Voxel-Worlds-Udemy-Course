...
public class Utils {
    ...
    static int maxHeight = 150; // height is considering column height is 16 units high
    ...
    {
        float height = Map(0, 30, 0, 1, fBM(x * smooth, z * smooth, octaves, persistence));
        return (int)height;
    }

    public static int GenerateStoneHeight(float x, float z)
    {
        float height = Map(0, maxHeight - 50, 0, 1, fBM(x * smooth * 2, z * smooth * 2, octaves + 1, persistence));
        return (int)height;
    }
